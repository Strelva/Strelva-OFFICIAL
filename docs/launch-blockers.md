...
- Dashboard queue approvals, event actions, inbox mark-read, and thread create/update writes now reject malformed or non-object JSON with `400 Invalid request body` before event, inbox, or thread storage work.
