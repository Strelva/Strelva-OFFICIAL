...
// Trades: single-page focus. Services + social proof + contact.
// No events, no providers, no shop — clean and direct.
const TRADES_PAGE_CONFIG: SitePageConfig = {
  home: {
    sections: [
      ...
      { type: "cta", visible: true, order: 5, props: { ctaText: "Get a Free Estimate", ctaHref: "#contact" } },
    ],
  },
  about: {
    sections: [
      ...
      { type: "cta", visible: true, order: 3, props: { ctaText: "Get a Free Estimate", ctaHref: "#contact" } },
    ],
  },
  contact: {
    sections: [
...
export const tradesTemplate: TemplateDefinition = {
  id: "trades",
