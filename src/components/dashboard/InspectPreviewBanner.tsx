  ...
  return (
    <div className="flex items-start gap-2.5 border-b border-amber-400/30 bg-amber-300/12 px-4 py-2.5 text-amber-100">
      ...
      <p className="text-[12px] leading-relaxed">
        <span className="font-semibold text-amber-50">Preview</span> — {tenantName}{" "}
        doesn&apos;t have {featureLabel} enabled. You&apos;re inspecting it as an
        operator; the client doesn&apos;t see this.
      </p>
    </div>
  );
}
