...
/**
 * Instagram section using official embed.js mechanism.
 * Zero tokens, zero API keys, zero action from the account owner.
 *
 * How it works: Instagram's own embed renders each post via their CDN.
 * Posts are curated (you pick which ones to show), not auto-fetched.
