...
export function WorkspaceHelp({ workspaceName, hasManagedService, onAgency }: { workspaceName?: string; hasManagedService?: boolean; onAgency?: () => void }) {
