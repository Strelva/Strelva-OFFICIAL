...
function ComposerSession({ initialRequest = "", draftKey, disabled = false, placeholder = "What would you like to do?", autoFocus = false, onSubmit, onTemplates }: WorkspaceComposerProps) {
  const id = useId();
